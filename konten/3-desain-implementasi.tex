...
Salah satu hal yang membedakan antara BERT dengan model - model yang lain adalah cara BERT di \textit{training}. Terdapat 2 langkah yang dilakukan untuk melakukan \textit{training} pada BERT. Yang pertama adalah dengan menutup sebagian kata - kata yang dijadikan sebagai masukan BERT,
